...
<template>
    <nav
        class="w-full px-10 border-b-2 dark:border-b-0 md:px-24 py-5 dark:bg-darkPrimaryBackground"
    >
            ...
            <div class="flex w-3/9 hidden md:block w-52 md:w-64">
                <ul class="flex">
                    <li class="flex md:w-16 lg:w-24 hlink">
                        <Link
                            href="/homepage"
                            class="hlink-text dark:text-white"
                            aria-current="page"
                            >Home</Link
                        >
                    </li>
        ...
        <button class="bg-primaryBackground w-24 h-10 mt-1 text-white rounded-r-xl hover:opacity-90 "
          @click="searchVideo()">Search</button>
            ...
            <div class="flex w-1/9">
                <div class="font-semibold p-1 mx-3 text-lg dark:text-white">
                ...
                <img
                    ...
                    "
                    alt=""
                    class="ml-4 noti-profile-menu rounded-full"
        ...
        <div
            class="absolute bg-white drop-shadow-lg right-3 top-24 w-44 rounded-lg z-40"
            v-if="menuShow"
        >
            <ul class="flex flex-col items-start pl-8 py-3">
                ...
                <li class="flex md:w-16 lg:w-24 hlink my-1">
                    <Link href="/blog" class="hlink-text" aria-current="page"
                        >Blog</Link
                    >
                </li>
                <li class="flex md:w-16 lg:w-24 hlink my-1">
                    <Link href="/video" class="hlink-text" aria-current="page"
                        >Video</Link
                    >
                </li>
            </ul>
