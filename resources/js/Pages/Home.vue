...
percentage = Math.floor(
    (Object.values(props.rank_mark)[0].sumMark / examCount) * 10
);
    ...
    <div>
        <section class="p-4 md:p-12 overflow-x-hidden">
            ...
            <div class="flex flex-row items-center justify-between">
                <h1 class="text-lg md:text-xl font-bold text-primaryBackground">
                    {{ count }} Classes Joined
                </h1>
                <h1 class="text-sm md:text-lg text-primaryBackground underline">
            ...
            <!-- Hero Section -->
            <div
                class="flex flex-col md:flex-row lg:flex-row justify-between items-center py-4 w-full"
            >
                <!-- Student's Card -->
                <swiper
                    :slides-per-view="1"
                ...
                >
                    ...
                    >
                        <div
                            class="p-4 md:p-8 lg:w-10/12 xl:w-8/12 md:w-5/6 mx-auto"
                        >
                            <div
                            ...
                            >
                                <div
                                    class="flex flex-row justify-between items-center z-10"
                                >
                                    <div class="flex flex-col space-y-3">
                                        ...
                                        <div class="flex flex-row">
                                            <div
                                                class="w-12 h-2 bg-secondaryBackground rounded-tl-md rounded-bl-md"
                                            ></div>
                                            <div
                                                class="w-12 h-2 bg-secondaryBackground mx-2"
                                            ></div>
                                            <div
                                                class="w-12 h-2 bg-white rounded-tr-md rounded-br-md"
                                            ></div>
                                        </div>
                                    </div>
                                    <div
                ...
                <!-- Class Info -->
                <div
                    class="flex flex-col md:pl-10 lg:w-9/12 xl:w-8/12 md:w-1/3 w-auto"
                >
                    <h1
                        class="text-lg md:text-xl font-bold text-primaryBackground dark:text-white"
                    >
                        Class info
                    </h1>
                    ...
                    <div class="relative">
                        <table
                            class="w-full text-sm text-left text-primaryBackground dark:text-white"
                        >
                            <tbody>
                                <tr>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="py-2 px-6 font-bold text-red-600"
                                    >
                                        {{
                                            moment(
                                                props.classes[activeIndex]
                    ...
                    <div class="flex mt-4">
                        <Link href="/recording">
                            <button
                                class="w-32 text-white bg-red-600 hover:bg-red-800 focus:outline-none font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2"
                            >
                                Rec Video
                            </button>
                        </Link>
        ...
        <!-- Rank Section -->
        <div
            class="flex flex-col w-full bg-primaryBackground dark:bg-darkPrimaryBackground py-10 my-5 h-full"
        >
            <div class="flex flex-row justify-around w-full items-center">
                <div class="flex flex-col items-center w-48">
                    <h1
                        class="text-2xl md:text-4xl text-secondaryBackground font-bold"
                    >
                        80%
                    </h1>
                ...
                <div class="flex flex-col items-center mb-32 w-48">
                    <div class="relative">
                        ...
                        <p class="text-5xl text-white font-bold rank">
                            {{ Object.values(props.examRanks)[0].rank }}
                        </p>
                    </div>
                    <p class="text-lg md:text-2xl text-white mt-5">
                        Current Rank
                    </p>
                </div>
                <div class="flex flex-col items-center w-48">
                    ...
                    <p class="text-md md:text-xl text-white mt-5">
                        Daily Exam Mark
                    </p>
                </div>
            </div>
            ...
            <div
                class="flex flex-col xl:flex-row justify-around items-center xl:space-y-0 space-y-5 p-5"
            >
                <!-- Rank Table -->
                <div
                    class="flex flex-col bg-white py-5 px-10 rounded-xl xl:w-2/5 h-96 dark:bg-darkSecondaryBackground"
                >
                    <table
                        class="text-sm text-left text-primaryBackground mb-4"
                    >
                        <thead>
                            <tr class="text-black">
                    ...
                    <div class="overflow-y-auto rankTable">
                        <table
                            class="text-sm text-left text-primaryBackground dark:text-white w-full"
                        >
                            <tbody>
                                <tr v-for="examRank in examRanks">
                                    <td
                                        class="py-3 w-24 text-left font-light text-xs text-black"
                                    >
                                        {{
                                            moment(
                                                examRank.date_submitted
                                            ).format("MMM D")
                                        }}
                                    </td>
                                    <td class="py-3 w-48 text-left font-bold">
                                        {{ examRank.e_name }}
                                    </td>
                                    <td
                                        class="py-3 w-24"
                                    ...
                                    <td class="py-3 w-24 text-left text-black">
                                        {{ examRank.rank }}
                                    </td>
                                </tr>
                            </tbody>
                ...
                <!-- Rank Chart -->
                <div
                    class="flex flex-col bg-white p-5 rounded-xl xl:w-2/5 h-96 dark:bg-darkSecondaryBackground"
                >
                    <Chart
        ...
        <!-- Rank Section -->
        <div
            class="flex flex-col w-full bg-primaryBackground py-10 my-5 h-full"
        >
            <div class="flex flex-row justify-around w-full items-center">
                <div class="flex flex-col items-center w-48">
                    <h1
                    ...
                    >
                        {{
                            props.attendance.length == 0
                                ? 0
                                : props.attendance[activeIndex].attend * 100
                        }}%
                    </h1>
                    <p class="text-md md:text-xl text-white mt-5">Attendance</p>
                </div>
                <div class="flex flex-col items-center mb-32 w-48">
                    <div class="relative">
                        ...
                        <p class="text-5xl text-white font-bold rank">
                            {{
                                Object.values(props.overall_rank)[activeIndex]
                                    .ranks
                            }}
                        </p>
                    </div>
                ...
                <div class="flex flex-col items-center w-48">
                    <h1
                        ...
                        :class="{
                            'text-green-500':
                                props.exam_percent.length == 0
                                    ? 0
                                    : props.exam_percent[activeIndex].exam ==
                                      100,
                            'text-red-500':
                                props.exam_percent.length == 0
                                    ? 0
            ...
            >
                <!-- Rank Table -->
                <div
                    class="flex flex-col bg-white py-5 px-10 rounded-xl xl:w-2/5 h-96"
                >
                    <table
                        class="text-sm text-left text-primaryBackground mb-4"
                    >
                    ...
                    <div class="overflow-y-auto rankTable">
                        <table
                            class="text-sm text-left text-primaryBackground w-full"
                        >
                            <tbody>
                ...
                <!-- Rank Chart -->
                <div
                    class="flex flex-col bg-white p-5 rounded-xl xl:w-2/5 h-96"
                >
                    <Chart
                        :options="chartOptions"
                        :series="series"
        ...
        <div class="flex flex-col items-center w-full">
            <h1 class="text-3xl md:text-5xl font-bold drop-shadow-xl my-3">
                Class Exam Ranking & Mark
            </h1>
            ...
            >
                ...
                <div
                    class="flex flex-col items-center bg-secondaryBackground py-10 px-3 w-full lg:w-72 space-y-4"
                >
                    <div
                        v-for="(item, index) in allRankPercentage"
                    ...
                    >
                        <span
                            ...
                            >{{ ++index }}</span
                        >
                        <h1 class="w-32 flex font-bold whitespace-nowrap">
                            {{ item.name }}
                        </h1>
                        <p class="font-semibold text-secondaryBackground">
                            {{ item.percent }}%
                        </p>
                    </div>
                </div>
