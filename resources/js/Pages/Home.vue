    ...
    <section class=" p-4 md:p-12 overflow-x-hidden">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-center py-4 w-full ">
            ...
            <div class="p-10 w-full">
                <swiper :cssMode="true" :navigation="true" :pagination="{ clickable: true }" :mousewheel="true"
                    :keyboard="true" :modules="modules">
                    <swiper-slide>
                        <div
                            ...
                            <div class="flex flex-row justify-between z-10">
                                <div class="flex flex-col space-y-4">
                                    <p>Attendance > <span
                                            class="ml-3 text-lg font-bold text-secondaryBackground">80%</span>
                                    </p>
                                    <p>Exam Mark > <span
                                            class="ml-3 text-lg font-bold text-secondaryBackground">60%</span>
                                    </p>
                                </div>
