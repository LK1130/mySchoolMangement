...
<template>
    ...
    <div :class="{dark: isDark}" class="bg-slate-800">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="py-2 px-6 font-bold">
                                        ...
                                        {{ props.classes[0].c_start_date }} ({{
                                                moment(props.classes[0].c_start_date).format('dddd')
                                        }})
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="py-2 px-6 font-bold">
                                        {{ moment(props.classes[0].start_join).format('YYYY/MM/DD') }} ({{
                                                moment(props.classes[0].start_join).format('dddd')
                                        }})
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="py-2 px-6 font-bold">
                                        {{ (moment(props.classes[0].end_date).format('MM') -
                                                moment(props.classes[0].c_start_date).format('MM')) + 1
                                        }} months
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="py-2 px-6 font-bold text-red-600">
                                        {{ moment(props.classes[0].end_date).format('YYYY/MM/DD') }} ({{
                                                moment(props.classes[0].end_date).format('dddd')
                                        }})
                                    </td>
                                </tr>
                                <tr>
        ...
        <div class="flex flex-col items-center w-full">
            <h1 class="text-3xl md:text-5xl font-bold drop-shadow-xl my-3" :class="{
                'text-white': (isDark.value == false),
                'text-black': (isDark.value == true)
            }">Class Exam Ranking & Mark</h1>
