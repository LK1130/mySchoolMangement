    ...
    <div>
        ...
        <div class="flex flex-col w-full bg-primaryBackground dark:bg-darkPrimaryBackground py-10 my-5 h-full">
            <div class="flex flex-row justify-around w-full items-center">
                ...
                <div class="flex flex-col items-center mb-32 w-48">
                    <div class="relative">
                        ...
                        <p class="text-5xl text-white font-bold rank">{{ Object.values(props.examRanks)[0].rank }}
                        </p>
                    </div>
            ...
            <div class="flex flex-col xl:flex-row justify-around items-center xl:space-y-0 space-y-5 p-5">
                <!-- Rank Table -->
                <div class="flex flex-col bg-white py-5 px-10 rounded-xl xl:w-2/5 h-96 dark:bg-darkSecondaryBackground">
                    ...
                    <div class="overflow-y-auto rankTable">
                        <table class="text-sm text-left text-primaryBackground  dark:text-white w-full">
                            <tbody>
                ...
                <!-- Rank Chart -->
                <div class="flex flex-col bg-white p-5 rounded-xl xl:w-2/5 h-96 dark:bg-darkSecondaryBackground">
