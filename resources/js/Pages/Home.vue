...
<template>
    ...
    <section class=" p-4 md:p-12 overflow-x-hidden">
        ...
        <!-- Hero Section -->
        <div class="flex flex-col xl:flex-row justify-between items-center py-4 w-full ">
            <!-- Student's Card -->

            <div class="p-10 lg:w-1/2 w-full">
                <div
                    ...
                    <div class="flex flex-row justify-between z-10">
                        <div class="flex flex-col space-y-4">
                            <p>Attendance > <span class="ml-3 text-lg font-bold text-secondaryBackground">80%</span>
                            </p>
                            <p>Exam Mark > <span class="ml-3 text-lg font-bold text-secondaryBackground">60%</span>
                            </p>
                        </div>
            ...
            <!-- Class Info -->
            <div class="flex flex-col px-10 xl:pl-36 lg:w-1/2 w-full">
                ...
                <div class="relative">
                    <table class="w-full text-sm text-left text-primaryBackground">
                        <tbody>
                            <tr>
                                <td scope="row" class="py-2 pr-12 whitespace-nowrap">
                                    Start Date
                                </td>
