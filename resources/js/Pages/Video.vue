                    ...
                    <div class="w-2/3 md:w-6/12 md:mx-auto  md:mt-0 mt-10 md:mb-10 mx-auto">
                        ...
                        <ul v-for="item in lecture"
                            ...
                            <li class="md:w-20 text-white md:text-standard text-base cursor-pointer">
                               <a :href="route('download',item.id)"> <ion-icon name="cloud-download-outline"></ion-icon></a>
                            </li>
                        </ul>
...
<style>
.scrollableVideoList::-webkit-scrollbar {
    height: 10px;
}

.scrollableVideoList::-webkit-scrollbar-thumb {
    background: #999;
    border-radius: 5px;
}
</style>